...
#download.file('https://github.com/FLARE-forecast/BVRE-data/bvre-platform-data/bvre-waterquality.csv', "bvre-waterquality.csv") 
#download.file('https://github.com/FLARE-forecast/BVRE-data/bvre-platform-data/BVRplatform.csv.csv', "BVRplatform.csv.csv")
...
bvrdata5=rbind(bvrdata3,bvrheader5)
